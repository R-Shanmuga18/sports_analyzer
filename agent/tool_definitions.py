...
TOOL_DEFINITIONS = [
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "DO NOT call this tool for narrative questions about years 2008-2022 and 2025-2026.\n\n"
                "For narrative questions about 2008-2022 and 2025-2026, use web_search instead.\n"
                "CRITICAL SEARCH RULE:\n"
                    "If you previously used query_data to find a specific player or team (e.g., finding out that Shubman Gill was the top scorer), "
                    "you MUST use their EXACT NAME in your search_docs query. \n"
                    "NEVER search for generic phrases like 'top scorer performance', 'winning team strategy', or 'current squad'. "
                    "Always search for the actual name: e.g., 'Shubman Gill 2023 performance'.\n\n"
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "If the user asks to 'list every' occurrence of a common event (like boundaries or wickets in a whole season),\n"
                "DO NOT attempt to return individual rows. You MUST write a SQL query that uses COUNT() to summarize it instead.\n\n"
                "CALL THIS TOOL when the question asks about:\n"
